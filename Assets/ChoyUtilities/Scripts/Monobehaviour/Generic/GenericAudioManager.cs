...
namespace EugeneC.Singleton
{
        ...
        where U : MonoBehaviour
    {
        ...
        public virtual void PlayClipAtPos(AudioResource resource, float3 pos, byte audioPriority = (byte)EAudioPriority.Average)
        {
        ...
        public virtual void PlayClip(AudioResource resource, byte audioPriority = (byte)EAudioPriority.Average) => PlayClipAtPos(resource, float3.zero, audioPriority);
