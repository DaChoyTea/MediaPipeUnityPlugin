...
namespace EugeneC.ECS
{
    ...
    public partial class MouseGrabFollowISystem : SystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            if (mass.HasInfiniteMass || massOverride.HasComponent(entity) && massOverride[entity].IsKinematic != 0) return;
            ...
            var camWorldPos = (float3)cam.ScreenToWorldPoint(new Vector3(input.Position.x, input.Position.y, data.MouseDepth));
